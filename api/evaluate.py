...
def planning(cache: any) -> tuple:
    ...
    if 'results' in planning_data and not(planning_data['results'] is None):
...
def freehold_title(cache: any) -> tuple:
    ...
    if 'postcode' in freehold_data and not(freehold_data['postcode'] is None):
...
def build_cost(cache: any) -> tuple:
    ...
    if 'postcode' in build_cost_data and not(build_cost_data['postcode' is None]):
